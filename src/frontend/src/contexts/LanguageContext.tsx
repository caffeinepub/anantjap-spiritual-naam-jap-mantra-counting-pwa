...
const translations: Record<Language, Record<string, string>> = {
  sanskrit: {
    ...
    benefits_desc:
      "नामजपः मनसः शान्तिं, आध्यात्मिकवृद्धिं च प्रदाति। नियमितजपेन चित्तं स्थिरं भवति, भक्तिः वर्धते च।",
  ...
  english: {
    ...
    benefits_desc:
      "Naam Jap brings peace to the mind and spiritual growth. Regular chanting stabilizes the mind and increases devotion.",
  ...
  hindi: {
    ...
    benefits_desc:
      "नाम जप मन को शांति और आध्यात्मिक विकास प्रदान करता है। नियमित जप से मन स्थिर होता है और भक्ति बढ़ती है।",
  ...
  gujarati: {
    ...
    benefits_desc:
      "નામ જપ મનને શાંતિ અને આધ્યાત્મિક વિકાસ આપે છે। નિયમિત જપથી મન સ્થિર થાય છે અને ભક્તિ વધે છે।",
